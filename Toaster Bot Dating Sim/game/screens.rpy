...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Laden Sie") action ShowMenu("load")
...
screen history():
    ...
    use game_menu(_("Geschichte"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0, spacing=gui.history_spacing):
